...
class FryingPan(Weapon):
    ...
    def pickup(self):
        if self.yeeted == True:
            print('You pick up the unbeatable yeetable')
            self.yeeted = False
        if self.yeeted == False:
            print('You already have the pan!')
...
class BallisticMat(Armor, QuestItem):
    def __init__(self, name, weight, value, points, description, defense_mod):
        Armor.__init__(self, name, weight, value, description, defense_mod)
        QuestItem.__init__(self, name, points, description)
...
class Room(object):
    def __init__(self, name, description, north, south, east, west, northwest, southwest, northeast, southeast, up,
                 down, item1, item2, item3, item4, item5, item6, item7, item8):
        self.description = description
        self.name = name
        self.north = north
        self.south = south
...
side_stair = Room('Side Staircase', 'You are on a staircase with two flights that leads up to the second and third '
                  ...
                  'spawn', 'laundry_room', 'basement_entrance', None, None, None, None, None, None, None, None, None,
                  None, None, None, None)
...
briefing_room = Room('Briefing Room', 'You are in a room with a few projectors and some desks.\nThere is a door leading'
                     ...
                     'basement_corridor', None, 'brief_desk', None, None, None, None, 'Backpack', None, None, None,
                     None, None, None, None)
...
garage_corridor = Room('Garage Hall', 'You are in a hallway that is not too long. There is a garage to your west, and '
                       ...
                       'main_corridor', 'garage', None, None, None, None, None, None, None, None, None, None, None,
                       None, None, None)
...
laundry_room = Room('Laundry Room', 'You are in a room with a wall directly in front of you that spans almost the whole'
                    ...
                    'side_stairs', None, None, 'laundry_inner', None, None, None, None, 'Backpack', None, None, None,
                    None, None, None, None)
laundry_inner = Room('Laundry Room', 'You have moved into the part of the laundry room that is closer to the inside of '
                     ...
                     'a bedroom on your west.', None, None, None, 'master_bed', None, 'laundry_ronom', None, None, None,
                     None, None, None, None, None, None, None, None, None)
storage_corridor_e = Room('Storage Corridor East', 'You are in a long hallway with a sharp turn in it to your west. You'
                          ...
                          ' your east. You can go west down the hall or south into a work area. There is a security '
                          'camera in the corner of the hall.', None, 'workshop', 'side_stair', 'storage_corridor_nw',
...
storage_corridor_nw = Room('Storage Corridor Northeast', 'You are in the corner of the hallway. You can see down the '
                           ...
                           'storage_corridor_e', 'mat_depot', None, None, None, None, None, None, None, None, None,
...
storage_corridor_s = Room('Storage Corridor South', 'You are at the south end of the hall and can see north. You see a '
                          ...
                          'workshop', 'storage', None, None, None, None, None, None, None, None, None, None, None,
                          None, None, None)
mat_depot = Room('Ballistic Mat Depot', 'Upon closer inspection, the mats appear to be some kind of armor plating.'
                 ...
                 None, None, None, None, None, None, 'BallisticMat', None, None, None, None, None, None, None)
...
master_bed = Room('Master Bedroom', 'You are in a bedroom with a box of supplies on a shelf. You see them but do not '
                  ...
                  None, None, None, None, 'laundry_inner', 'bathroom', None, None, 'Armor', 'Flashbang', 'PistolAmmo',
                  'RifleAmmo', 'ShotgunAmmo', 'Frag', None, None)
basement_stair_in = Room('Basement Stairs', 'You are on a stair case that leads down to basement corridor and up to the'
                         ...
                         'main_stairs', None, None, None, None, None, None, None, None, None)
stairs_2nd = Room('Second Floor Stairs', 'You are on a flight of stairs that leads up to the third floor, and down to '
                  ...
                  None, None, 'stairs_3rd', 'main_stairs_1st', None, None, None, None, None, None, None, None)
...
storage = Room('Storage', 'You are in a room with lots of supplies for the base. There are so many things that could be'
               ...
               'D50', 'Supernova', None, None, None, None, None)
workshop = Room('Workshop', 'There is a workbench and a boatload of tools you have never seen but somehow know how to '
                'use. There are enough tools and machines to craft very complex things, and the tools might help you '
                'fix the car. There are doors to your north and west that lead into the storage corridor.',
                'storage_corridor_e', None, None, 'storage_corridor_s', None, None, None, None, None, None, None, None,
...
piano_lounge = Room('Piano Lounge', 'There is a piano in the middle of the room. It appears to be in working order.'
                    ...
                    'main_corridor', None, None, None, None, None, None, None, None, None, None, None, None, None, None)
tv_room = Room('TV Room', 'There is a TV and a chair in front of it. The remote is on the chair. There is a door to the'
               'east.', None, None, 'main_corridor', None, None, None, None, None, None, None, 'TVRemote', 'TV', None,
               None, None, None, None, None)
...
garage = Room('Garage', 'As you enter the room, the feeling of "Man, I want out of here" hits you really hard. There is'
              ...
              'west.', None, None, None, 'garage_corridor', None, None, None, None, None, None, None, None, None, None,
              None, None, None, None)
...
maintenance = Room('Maintenance Area', 'You stand in a room with some cleaning solutions, a couple metal barrels, and a'
                   'bunch of mops. There are car parts like a battery in here. There are doors to your east into the '
                   'basement corridor and north into the armory.', 'armory', None, 'bm_corridor', None, None, None,
                   None, None, None, None, 'CarBattery', None, None, None, None, None, None, None)
armory = Room('Armory', 'You have hit the motherlode of weaponry. Guns everywhere, and ammo everywhere else. All kinds '
              ...
              'Rifle, M1A1 Carbine, Colt 1911 pistol, and a T-5 SMG, and all the ammo you could need. There are exits '
              'to the corridor on the northeast side of the room, and a path to the maintenance area at your south '
              'side.', None, 'maintenance', None, None, None, None, 'bm_corridor', None, None, None, 'T5smg',
              'M1A1Carbine', 'SIX12', 'MK14', 'Colt1911', 'PistolAmmo', 'RifleAmmo', 'ShotgunAmmo')
...
bm_corridor = Room('Basement Corridor', 'You are in a corridor with lots of rooms connected to it. The maintenance area'
                   ...
                   None, None, 'maintenance', 'lockers', 'briefing_room', None, None, None, None, None, None, None,
                   None, None, None)
office = Room('Office', 'You are in an office with some office supplies like paper and staplers. There is a computer. '
              ...
              'east', None, None, 'corridor_2', None, None, None, None, None, None, None, None, None, None, None, None,
              None, None, None)
...
while True:
    ...
    if command in directions:
        ...
        if command == 'YES':
            ...
            mc.health -= 10000000
            print('   _      _ _____ _    _   _____ _____ ______ _____\n'  
                  '   \ \   / / __ \| |  | | |  __ \_   _|  ____|  __ \ \n' 
                  '    \ \_/ / |  | | |  | | | |  | || | | |__  | |  | |\n'
                  '     \   /| |  | | |  | | | |  | || | |  __| | |  | |\n'
                  '      | | | |__| | |__| | | |__| || |_| |____| |__| |\n'
